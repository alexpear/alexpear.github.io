...
export class BlockScout {
    ...
    tileLayer: TileLayer | undefined = undefined;
    playerMarker: PlayerMarker | undefined = undefined;
    renderedGoals: Map<string, GoalLabel> = new Map();
